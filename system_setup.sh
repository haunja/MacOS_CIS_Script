...
# 3 Logging and Auditing
    ...
    # 3.3 Ensure security audit retention(Scored)
    sudo /usr/bin/sed -i '' 's/^expire-after:.*/expire-after:60D\ OR\ 1G/' /etc/security/audit_control
    ...
    # 3.6 Ensure firewall is configured to login
